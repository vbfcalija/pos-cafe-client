<template>
    <button type="button"
        ...
        :class="[
            ...
            props.buttonStyle === 'incident' && '!rounded-lg bg-red-400 text-white hover:bg-red-500 text-xs !px-3 !py-1.5',
            props.buttonStyle === 'incident-link' && 'text-red-600 hover:text-red-700 text-xs',
